  ...
  useEffect(() => {
    switch (playerCount) {
      ...
      case 3:
        ...
        break;
      case 7:
        setContainerDimensions({ width: "20%", height: "45%", fontSize: 11 });
        break;
      case 8:
        setContainerDimensions({ width: "20%", height: "45%", fontSize: 11 });
        break;
      case 9:
        setContainerDimensions({ width: "18%", height: "45%", fontSize: 11 });
        break;
      case 10:
        setContainerDimensions({ width: "18%", height: "45%", fontSize: 11 });
        break;
      default:
        setContainerDimensions({ width: "25%", height: "45%", fontSize: 11 });
        break;
    }
  }, [playerCount]);
